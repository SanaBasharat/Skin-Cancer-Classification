...
torch.save(best.produce_model(), 'cnn_model.pt')
loadedTorchModel = torch.load('cnn_model.pt')

from keras.models import load_model

best_kerasModel.save('cnn_model.h5')
loadedKerasModel = load_model('cnn_model.h5')
